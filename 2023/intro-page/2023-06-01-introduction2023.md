...
<iframe width="420" height="315" src="https://player.bilibili.com/player.html?aid=229312966&bvid=BV1o8411f7Xt&cid=1150574396&page=1" frameborder="0" allowfullscreen sandbox=""></iframe>
...
考虑每一个听众可能对类型论有不同的了解程度，并且这也是第一次暑校活动，所以我们专门地邀请了六位讲师给大家来一次贴心"补课"。以下课程参考了学习类型论的常规路径和本次暑校中talks要求的前置知识，课程讲解顺序从上至下。 
...
|日期|下午2点-4点|晚上8点-9点|
|:----:|:----:|:----:|
|7月2日|**Alias Qli**<br>λ演算和简单类型入门 (第一节和第二节)| 无 |
|7月3日|**Alias Qli**<br>λ演算和简单类型入门 (习题答疑1和第三节)| 无 |
|7月4日|**面皮**<br>依值类型入门 (第一节和第二节)|**Alias Qli**<br>λ演算和简单类型入门 (习题答疑2)|
|7月5日|**Trebor**<br>范畴论与范畴语义<br><br>范畴-函子-自然变换 (第一节)<br>伴随-米田引理 (第二节) |**面皮**<br>依值类型入门 (习题答疑1)|
|7月6日| **Trebor**<br>范畴论与范畴语义 (习题答疑1) | **oCaU**<br>Agda使用入门 (第一节)  |
|7月7日|**天生万物以养人**<br>Coq和Lean入门介绍 (第一节和第二节) | **oCaU**<br>Agda使用入门 (习题答疑和第二节) |
|7月8日|**oCaU**<br>Agda使用入门 (习题答疑和第三节) | 无  |
|7月9日|**无懈可击99**<br>同伦类型论(HoTT)入门 (第一节和第二节)| **无懈可击99**<br>同伦类型论(HoTT)入门 (习题答疑1) |
|7月10日|**无懈可击99**<br>同伦类型论(HoTT)入门 (第三节和第四节)| **无懈可击99**<br>同伦类型论(HoTT)入门 (习题答疑2) |
|7月11日|**千里冰封**<br>立方类型论(Cubical)入门 (第一节和第二节) |**无懈可击99**<br>同伦类型论(HoTT)入门 (第五节) |
|7月12日|**千里冰封**<br>立方类型论(Cubical)入门 (习题答疑1和第三节)| 无 |
|7月13日|**千里冰封**<br>立方类型论(Cubical)入门 (习题答疑2和第四节)| 无 |
...
* [Alias Qli](https://github.com/AliasQli)
