...
|7月3日|**Alias Qli**<br>λ演算和简单类型入门 <br><br>STLC 的实现 (第三节)| **Alias Qli**<br>λ演算和简单类型入门 (习题答疑1) |
|7月4日| 待排 | **Alias Qli**<br>λ演算和简单类型入门 (习题答疑2) |
|7月5日|**面皮**<br>依值类型入门 (第一节和第二节)| **面皮**<br>依值类型入门 (习题答疑1) |
|7月6日|无|**oCaU**<br>Agda使用入门 (第一节)  |
|7月7日|**天生万物以养人**<br>Coq和Lean入门介绍 (第一节和第二节)|**oCaU**<br>Agda使用入门 (习题答疑2) |
|7月8日|**oCaU**<br>Agda使用入门 (习题答疑1和第三节) | 无  |
|7月9日|**无懈可击99**<br>同伦类型论(HoTT)入门 (第一节和第二节)|**oCaU**<br>Agda使用入门 (习题答疑2)|
|7月10日|**Trebor**<br>范畴论与范畴语义<br><br>范畴-函子-自然变换 (第一节)|**无懈可击99**<br>同伦类型论(HoTT)入门 (习题答疑1)|
|7月11日|**无懈可击99**<br>同伦类型论(HoTT)入门 (第三节和第四节)|**Trebor**<br>范畴论与范畴语义 (习题答疑1)|
|7月12日|**Trebor**<br>范畴论与范畴语义<br><br>伴随-米田引理 (第二节)|**无懈可击99**<br>同伦类型论(HoTT)入门 (习题答疑2)|
|7月13日|**无懈可击99**<br>同伦类型论(HoTT)入门 (习题答疑2和第五节) | **Trebor**<br>范畴论与范畴语义 (习题答疑2) |

**7月14日-7月16日课程安排**:

|日期|晚上8点-10点|
|:----:|:----:|:----:|
|7月14日|**千里冰封**<br>立方类型论(Cubical)入门 (第一节和第二节)|
|7月15日|**千里冰封**<br>立方类型论(Cubical)入门 (第三节和第四节)|
|7月16日|**千里冰封**<br>立方类型论(Cubical)入门 (习题答疑1)|
