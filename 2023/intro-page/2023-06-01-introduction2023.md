...
|日期|下午2点-4点|晚上8点-9点|
|:----:|:----:|:----:|
|7月2日|**Alias Qli**<br>λ演算和简单类型入门 (第一节)<br><br>STLC 的入门 (第一节) | 无 |
|7月3日|**Alias Qli**<br>λ演算和简单类型入门 (第二节)<br><br>STLC 的延伸 (第二节) | **Alias Qli**<br>λ演算和简单类型入门 (习题答疑1) |
|7月4日|**Alias Qli**<br>λ演算和简单类型入门 (第三节)<br><br>STLC 的实现 (第三节)| 无 |
|7月5日|**面皮**<br>依值类型入门 (第一节和第二节)| **Alias Qli**<br>λ演算和简单类型入门 (习题答疑2) <br><br> **面皮**<br>依值类型入门 (习题答疑1) |
